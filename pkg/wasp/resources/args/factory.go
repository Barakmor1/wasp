...
type FactoryArgs struct {
	MaxSwapInPagesPerInterval  string `required:"true" split_words:"true"`
	MemoryMaxThreshold         string `required:"true" split_words:"true"`
	MaxSwapOutPagesPerInterval string `required:"true" split_words:"true"`
